...
/**
 * \file    speakdo/admin/about.php
 * \ingroup speakdo
 * \brief   About page of module SpeakDo.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "speakdo@speakdo"));
...
llxHeader('', $langs->trans($title), $help_url, '', 0, 0, '', '', '', 'mod-speakdo page-admin_about');
...
print dol_get_fiche_head($head, 'about', $langs->trans($title), 0, 'speakdo@speakdo');
